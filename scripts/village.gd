...
func _build_village() -> void:
	...
	var training_label = _make_label("Training Area", Vector2(420, 30))
	...
	var gate_label = _make_label("Village Gate", Vector2(-50, 550))
...
func _make_building(center: Vector2, size: Vector2, color: Color, label_text: String, interior_scene: String) -> void:
	...
	# Label
	var lbl = _make_label(label_text, center + Vector2(-size.x * 0.5, -size.y * 0.5 - 18))
	add_child(lbl)
