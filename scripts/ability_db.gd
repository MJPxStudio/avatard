...
const _ABILITIES: Dictionary = {
	...
	"gentle_fist": {
		...
		"name":        "Gentle Fist",
		"source":      "clan:hyuga",
		"description": "A precise palm strike that bypasses armor and deals internal damage.",
		"chakra_cost": 15,
		"cooldown":    2.5,
	...
	"palm_thrust": {
		...
		"name":        "Palm Thrust",
		"source":      "clan:hyuga",
		"description": "A powerful open-palm strike that knocks the enemy back and briefly stuns them.",
		"chakra_cost": 20,
		"cooldown":    4.0,
		"script_path": "res://scripts/abilities/hyuga/palm_thrust.gd",
		"icon_color":  Color("a0d0f0"),
		"activation":  "instant",
		"tags":        ["melee", "knockback"],
	},
	"rotation": {
		"id":          "rotation",
		"name":        "Eight Trigrams: Rotation",
		"source":      "clan:hyuga",
		"description": "Spin rapidly, releasing chakra in all directions. Damages and knocks back all nearby enemies.",
		"chakra_cost": 35,
		"cooldown":    8.0,
	...
	"64_palms": {
		...
		"source":      "clan:hyuga",
		"description": "Deliver 64 rapid strikes sealing the enemy's chakra points. Deals heavy damage and drains chakra.",
		"chakra_cost": 50,
		"cooldown":    14.0,
	...
	"128_palms": {
		...
		"source":      "clan:hyuga",
		"description": "The pinnacle of Gentle Fist — 128 devastating strikes that annihilate an enemy's chakra network.",
		"chakra_cost": 80,
		"cooldown":    22.0,
		"script_path": "res://scripts/abilities/hyuga/128_palms.gd",
		"icon_color":  Color("0068cc"),
		"activation":  "instant",
		"min_rank":    "Jonin",
		"tags":        ["melee"],
	},
	...
	"c2_dragon": {
		...
		"chakra_cost": 45,
		"cooldown":    14.0,
		"script_path": "res://scripts/abilities/clay/c2_dragon.gd",
